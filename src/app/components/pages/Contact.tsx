...
export function Contact() {
  ...
  const [form, setForm] = useState({ name: "", email: "", relation: "", message: "" });
  ...
  return (
    <div className="overflow-x-clip">
      ...
      <section className="relative">
        <div className="blob" style={{ width: 480, height: 480, top: -120, right: -140, background: "var(--mauve-soft)" }} />
        <div className="blob" style={{ width: 380, height: 380, top: 200, left: -120, background: "var(--sage-soft)", opacity: 0.55 }} />
          ...
          <div className="grid grid-cols-1 lg:grid-cols-12 gap-12 items-end">
            <div className="lg:col-span-7">
              ...
              <h1 className="font-display mt-5 max-w-[20ch] rise rise-2">
                Reach out <span className="italic-serif text-[color:var(--plum)]">whenever you&apos;re ready</span>, even just to ask.
              </h1>
              <p className="mt-7 max-w-[58ch] text-[1.1rem] text-[color:var(--ink-soft)] rise rise-3">
                You don&apos;t need to have it figured out before contacting us. Tell us what&apos;s going on in your family, and we&apos;ll point you toward the right starting place.
              </p>
            </div>
      ...
      <section className="px-5 sm:px-8 lg:px-12">
        <div className="max-w-[1240px] mx-auto grid grid-cols-1 lg:grid-cols-12 gap-6">
          ...
          <div className="lg:col-span-7 relative rounded-[2rem] overflow-hidden border border-[color:var(--hairline)] bg-[color:var(--plum)] text-[color:var(--ivory)]">
            <div className="blob" style={{ width: 420, height: 420, top: -160, right: -80, background: "var(--mauve)" }} />
            <div className="relative p-10 sm:p-12">
              <p className="eyebrow text-[color:var(--mauve-soft)]">Booking</p>
              <h2 className="font-display mt-3 text-[color:var(--ivory)]">
                Schedule through our <span className="italic-serif text-[color:var(--mauve-soft)]">secure portal.</span>
              </h2>
              <p className="mt-5 max-w-[50ch] text-[color:var(--ivory)]/85">
                Appointments are managed through our HIPAA-compliant client portal. You&apos;ll see live availability, intake forms, and session reminders in one place.
              </p>
          ...
          <div className="lg:col-span-5 warm-card p-10 flex flex-col">
            ...
            <h2 className="font-display mt-3 text-[2rem]">
              What to expect <span className="italic-serif text-[color:var(--plum)]">before</span> your first session.
            </h2>
            <ul className="mt-6 space-y-5 text-[color:var(--ink-soft)] text-[0.97rem] leading-relaxed">
              <li>
                <span className="block font-display text-[1.1rem] text-[color:var(--plum-ink)] mb-1">1 · A short intake</span>
                After requesting an appointment, you&apos;ll receive a brief intake form so we can understand your child&apos;s age, situation, and what&apos;s prompting the visit.
              </li>
              <li>
                <span className="block font-display text-[1.1rem] text-[color:var(--plum-ink)] mb-1">2 · A free intro call</span>
                A 15-minute conversation, no obligation, so we can recommend the right format and frequency.
              </li>
              <li>
                <span className="block font-display text-[1.1rem] text-[color:var(--plum-ink)] mb-1">3 · Your first session</span>
                Telehealth or in-person. Caregivers are welcome, and for younger children, expected, in the early sessions.
              </li>
            </ul>
          </div>
        </div>
        ...
        <div className="max-w-[1100px] mx-auto grid grid-cols-1 lg:grid-cols-12 gap-12">
          <div className="lg:col-span-5">
            ...
            <h2 className="font-display mt-3">
              Or just say <span className="italic-serif text-[color:var(--plum)]">hello.</span>
            </h2>
            <p className="mt-5 text-[color:var(--ink-soft)] max-w-[40ch]">
              Email works too, we read every message ourselves and reply within two business days.
            </p>
            <a
          ...
          <div className="lg:col-span-7">
            {submitted ? (
              <div className="warm-card p-10 text-center">
                <h3 className="font-display text-[1.6rem]">Thank you, your message is on its way.</h3>
                <p className="mt-3 text-[color:var(--ink-soft)]">
                  We&apos;ll be in touch within two business days. If your family needs urgent medical attention, please call 911 or contact your medical provider.
                </p>
              </div>
            ) : (
              <form onSubmit={handleSubmit} className="warm-card p-8 sm:p-10 space-y-5">
                ...
                <Field label="Relationship to the child" id="relation" hint="Optional, e.g. parent, grandparent, teen self">
                  <input
                    id="relation"
                    type="text"
                    value={form.relation}
                ...
                <button type="submit" className="pill-btn pill-btn--primary w-full sm:w-auto">
                  Send message
                  <ArrowUpRight className="w-4 h-4" />
                </button>
                <p className="text-[0.78rem] text-[color:var(--ink-soft)]/80">
                  Please don&apos;t share sensitive medical details here. Once we&apos;re working together, we&apos;ll move to our secure portal.
                </p>
              </form>
            )}
          </div>
      ...
      <section className="px-5 sm:px-8 lg:px-12 pb-24">
        <div className="max-w-[920px] mx-auto">
          <div className="text-center mb-12">
            ...
            <h2 className="font-display mt-3">
              Questions families <span className="italic-serif text-[color:var(--plum)]">actually ask.</span>
            </h2>
          </div>
...
function Field({
  ...
  return (
    <div className="flex flex-col gap-2">
      <label htmlFor={id} className="text-[0.85rem] font-medium text-[color:var(--plum-ink)]">
        {label}
        {hint && <span className="ml-2 text-[color:var(--ink-soft)]/70 font-normal">{hint}</span>}
      </label>
      {children}
    </div>
  );
    ...
    <div className="warm-card p-7">
      ...
      <ul className="mt-5 space-y-5">
        <li className="flex items-start gap-3">
          ...
          <div>
            <p className="font-display text-[1.05rem] leading-tight">Telehealth across Colorado</p>
            <p className="text-[0.88rem] text-[color:var(--ink-soft)] mt-1">Secure video sessions, statewide.</p>
          </div>
        </li>
        <li className="flex items-start gap-3">
          ...
          <div>
            <p className="font-display text-[1.05rem] leading-tight">
              <a href="mailto:info@achildsperspective.com" className="hover:underline">
                info@achildsperspective.com
              </a>
            </p>
            <p className="text-[0.88rem] text-[color:var(--ink-soft)] mt-1">Replies within two business days.</p>
          </div>
        </li>
        <li className="flex items-start gap-3">
          ...
          <div>
            <p className="font-display text-[1.05rem] leading-tight">By appointment only</p>
            <p className="text-[0.88rem] text-[color:var(--ink-soft)] mt-1">Booked through our secure client portal.</p>
          </div>
        </li>
      </ul>
    </div>
